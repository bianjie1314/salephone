...
<body>
	...
	<div class="page-container">
		...
		<div class="text-c">
			...
			<input type="text"  placeholder=" 用户名称/手机号" name="text" value="${searchVo.text}"
				...
				<tbody>
					<c:if test="${userList != null }">
						...
						<td class="f-14 td-manage">
							...
							onClick="alertShow('修改信息','${pageContext.request.contextPath }/user/getUserById/${user.id}?view=admin/user/user-edit','700','700')"
