...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="">手机销售系统后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
				...
				<%-- <ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加资讯','${pageContext.request.contextPath }/common/article_article-add')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
							<li><a href="javascript:;" onclick="picture_add('添加资讯','${pageContext.request.contextPath }/common/picture_picture-add')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
							<li><a href="javascript:;" onclick="product_add('添加资讯','${pageContext.request.contextPath }/common/product_product-add')"><i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
							<li><a href="javascript:;" onclick="member_add('添加用户','${pageContext.request.contextPath }/common/member_member-add','','510')"><i class="Hui-iconfont">&#xe60d;</i> 用户</a></li>
					</ul>
				</li>
			</ul> --%>
		</nav>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<%--	<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath }/phone/getPhoneList?start=0&offset=10" data-title="商品列表" href="javascript:void(0)">数据列表</a></li>
					<li><a data-href="${pageContext.request.contextPath }/newsRole/chartInfo" data-title="比例分配" href="javascript:void(0)">比例分配</a></li>
