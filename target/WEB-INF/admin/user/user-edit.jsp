	...
	<form class="form form-horizontal" action="">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${userInfo.username}" placeholder="输入用户名称" name="username">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>手机号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${userInfo.mobile}" disabled placeholder="输入手机号" name="mobile">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>账户余额：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" disabled value="${userInfo.balance}" placeholder="账户余额" name="balance">
			</div>
		</div>
		<div class="row cl">
