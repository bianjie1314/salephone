...
<header class="container">
	<div class="row">
		<div class="col-md-4">
			<div id="logo"><img src="${pageContext.request.contextPath }/clientlib/images/logo.png" /></div>
		</div>
		<div class="col-md-4">
			<form class="form-search">
				<input type="text" name="searchText" placeholder="手机名/型号"  class="input-medium search-query">
				<button type="button"  onclick="searchPhone(null)" class="btn"><span class="glyphicon glyphicon-search"></span></button>
			</form>
		</div>
		<div class="col-md-4">
		</div>
