	...
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${shopInfo.name}" placeholder="输入店铺名称" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">位置：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="location" id="location" placeholder="输入地理位置" value="${shopInfo.location}" class="input-text">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<fmt:formatDate value="${shopInfo.createTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" />
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">更新时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<fmt:formatDate value="${shopInfo.updateTime}" pattern="yyyy年MM月dd日HH点mm分ss秒" />
			</div>
		</div>
		<div class="row cl">
